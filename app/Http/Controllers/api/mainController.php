...
class mainController extends Controller
{
    ...
    {
        try {
            $listAll = DB::select(" SELECT d.fs_nm_pasien, d.fs_mr, h.fs_no_sep, h.fd_tgl_trs, h.fs_no_peserta, g.fs_nm_layanan, f.fs_nm_bed, e.fs_nm_kelas, b.fd_tgl_in , sum(a.fn_total) fn_count_all, b.fs_kd_reg 
                            ...
                            where b.fd_tgl_out='3000-01-01' and b.fd_tgl_void='3000-01-01' and c.fs_kd_tipe_jaminan in ('NPB01','PBI01') group by d.fs_nm_pasien, d.fs_mr, h.fs_no_sep, h.fd_tgl_trs, h.fs_no_peserta, g.fs_nm_layanan,
